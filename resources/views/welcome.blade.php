        ...
        <main class="flex-shrink-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                <div class="container px-5">
                    <a class="navbar-brand" href="index.html"><span class="fw-bolder text-primary">Inventaris</span></a>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-light mb-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Modi repudiandae, nihil blanditiis mollitia ipsam hic deleniti illum debitis non praesentium sit corrupti accusamus eius id dolor odit sed cupiditate ex.</p>
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto"><div class="small m-0">Copyright &copy; Inventaris UKK</div></div>
                    <div class="col-auto">
